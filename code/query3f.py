...
spark = SparkSession.builder.appName("Query 3 with SHUFFLE HASH").getOrCreate()
...
crime_with_zip_df = filtered_crime_df.hint("shuffle_hash").join(
...
crime_with_income_df = crime_with_zip_df.hint("shuffle_hash").join(
    filtered_income_df,

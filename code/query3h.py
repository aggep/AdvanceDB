...
spark = SparkSession.builder.appName("Query 3 with MERGE").getOrCreate()
...
crime_with_zip_df = filtered_crime_df.hint("MERGE").join(
...
crime_with_income_df = crime_with_zip_df.hint("MERGE").join(
        filtered_income_df,
